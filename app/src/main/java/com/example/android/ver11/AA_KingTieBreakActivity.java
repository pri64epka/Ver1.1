...
public class AA_KingTieBreakActivity extends AppCompatActivity {
    ...
    public void onBackPressed() {
        ...
        if (mDbHelper.getNumOfEmptyRows() > 0) {
    ...
    public void notEnoghRows() {
        ...
        ad = new AlertDialog.Builder(context);
        ad.setMessage(getString(R.string.The_result_could_not));
        ad.setPositiveButton(getString(R.string.Yes), new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int arg1) {
                noSaveResultGoToMM();
            }
        });
        ad.setNeutralButton(getString(R.string.No), new DialogInterface.OnClickListener() {
