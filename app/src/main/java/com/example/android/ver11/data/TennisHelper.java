package com.example.android.ver11.data;
...
import static com.example.android.ver11.AA_NewMatchActivity.currDay;
import static com.example.android.ver11.AA_NewMatchActivity.currMon;
import static com.example.android.ver11.AA_NewMatchActivity.currYear;
...
public class TennisHelper extends SQLiteOpenHelper {
    ...
    public void putName13(String fName, String modeM, String surface, String na1, String na2, String nb1, String nb2,
        ...
        db.update(Contract.StatTableSave.STATISTIC_SAVE, values1, Contract.StatTableSave._ID + " = ?", new String[]{String.valueOf(getMinIdStatSaveTable())});
    }
    ...
    public void insertNewRow() {
        ...
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues values = new ContentValues();
        values.put(Contract.StatTableSave.COLUMN_ADD, -2);
        long newRowId = db.insert(Contract.StatTableSave.STATISTIC_SAVE, null, values);
    }
